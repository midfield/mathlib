...
generate_from {s : set α | ∃ (a : α), s = Ioi a ∨ s = Iio a}
...
⟨by { convert @order_topology.topology_eq_generate_intervals α _ _ _ using 1,
  dunfold preorder.topology, conv in (_ ∨ _) { rw or.comm }, refl }⟩
...
lemma nhds_basis_order_unbounded {a : α} (hl : ∃l, l < a) (hu : ∃u, a < u) :
